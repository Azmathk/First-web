...
const banner = figlet.textSync('GetBenefits', {
  font: 'Small Slant', // Ghost, Standard, Slant, Doom, Big, Mini, Small, Standard, Sub-Zero, ANSI Shadow, Bloody, Calvin S, Doh, Epic, Isometric1, Isometric2, Isometric3, Isometric4, Larry 3D, Ogre, Puffy, Rectangles, Slant Relief, Small Slant, Soft, Standard, Star Wars, Straight, Thick, Thin, Univers
...
const start = async () => {
  ...
  const client = Baileys({
    ...
    browser: ['GetBenefits', 'silent', '5.0.0'],
...
// Copyright notice
console.log(chalk.red.bold('GetBenefits is made with ❤️'));
